...
class Path{
    ...
    /*
    * Supprime le dernier élément d'un chemin d'acces.
    */
    public static function clear_last($path){
    ...
    /**
    *$subtil signifie de supprimer les terme semblable au sein d'un chemin
    */
